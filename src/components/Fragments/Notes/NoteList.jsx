...
function NoteList({ notes, label, setNotes }) {
  ...
  return (
    <>
      <h2 className="font-semibold mt-6 mb-4 text-slate-900 dark:text-slate-100 text-lg md:text-xl pl-4 relative before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1 before:h-5 before:bg-gradient-to-br before:from-blue-500 before:to-blue-600 before:rounded before:mr-2">
        {label}
      </h2>
